...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "contactTitle":"SAMPLE_TEXT", "contactFirst":"SAMPLE_TEXT", "contactSurname":"SAMPLE_TEXT", "tel":"SAMPLE_TEXT", "mob":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "address1":"SAMPLE_TEXT", "address2":"SAMPLE_TEXT", "address3":"SAMPLE_TEXT", "town":"SAMPLE_TEXT", "postCode":"SAMPLE_TEXT", "products":"SAMPLE_TEXT", "interested":"SAMPLE_TEXT", "notes":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
